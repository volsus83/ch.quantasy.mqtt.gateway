 ...
 * @author reto
 */
public class ServantContract extends ClientContract {

    public ServantContract(String rootTopic, String baseClass, String instanceID) {
        super(rootTopic, baseClass, instanceID);
    }
}
